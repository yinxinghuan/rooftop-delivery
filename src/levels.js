...
export const LEVELS = [
  ...
  { id: 2, titleKey: 'level2Title', missionKey: 'level2Mission', scene: 'laundry', parcel: { box: 0x4f83b8, tape: 0xfff5de, label: 'AIR / 02' }, animals: [{ type: 'cat', amplitude: 2.7, period: 4.2, radius: 0.68, deflect: 1.8, lift: 0.7, zOffset: 0 }], parcels: 5, maxMisses: 2, windMax: 1.25, windMin: 0.35, targetScale: 1, deliveredGoal: 4, bullseyeGoal: 0, scoreGoal: 0, moveAmplitude: 0, movePeriod: 0 },
  { id: 3, titleKey: 'level3Title', missionKey: 'level3Mission', scene: 'garden', parcel: { box: 0x5d9b67, tape: 0xf4ead8, label: 'BIO / 03' }, animals: [{ type: 'dog', amplitude: 2.4, period: 3.6, radius: 0.78, deflect: 2.2, lift: 0.55, zOffset: 0 }], parcels: 6, maxMisses: 2, windMax: 1.05, windMin: 0, targetScale: 0.82, deliveredGoal: 5, bullseyeGoal: 1, scoreGoal: 0, moveAmplitude: 0, movePeriod: 0 },
  ...
  { id: 5, titleKey: 'level5Title', missionKey: 'level5Mission', scene: 'glasshouse', parcel: { box: 0xf4ead8, tape: 0xe0483b, label: 'FRAGILE' }, animals: [{ type: 'chicken', amplitude: 2, period: 3, radius: 0.62, deflect: 1.45, lift: 0.95, zOffset: 0 }], parcels: 7, maxMisses: 1, windMax: 1.15, windMin: 0, targetScale: 0.9, deliveredGoal: 6, bullseyeGoal: 2, scoreGoal: 0, moveAmplitude: 0, movePeriod: 0 },
  { id: 6, titleKey: 'level6Title', missionKey: 'level6Mission', scene: 'beacon', parcel: { box: 0x353544, tape: 0xf2c14e, label: 'FINAL / 06' }, animals: [{ type: 'cat', amplitude: 2.6, period: 3.4, radius: 0.68, deflect: 1.8, lift: 0.7, zOffset: -0.6 }, { type: 'dog', amplitude: 2.25, period: 4.1, radius: 0.78, deflect: 2.2, lift: 0.55, zOffset: 0.6, phase: Math.PI }], parcels: 8, maxMisses: 2, windMax: 1.35, windMin: 0, targetScale: 0.82, deliveredGoal: 7, bullseyeGoal: 2, scoreGoal: 500, moveAmplitude: 0.75, movePeriod: 3.2 },
]
