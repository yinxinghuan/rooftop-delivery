const dictionaries = {
  en: {
    ...
    level2Title: 'CROSSWIND ROW', level2Mission: 'Deliver 4 · strong wind · cat patrol',
    level3Title: 'NARROW LANDING', level3Mission: 'Deliver 5 · 1 bullseye · dog patrol',
    level4Title: 'MOVING ADDRESS', level4Mission: 'Deliver 4 · score 300',
    level5Title: 'FRAGILE EXPRESS', level5Mission: 'Deliver 6 · 2 bullseyes · chicken',
    level6Title: 'SKYLINE FINALE', level6Mission: 'Deliver 7 · 2 bullseyes · 500 · cat + dog',
    animalInterference: 'ANIMAL INTERFERENCE', catHit: 'The cat swatted it!', dogHit: 'The dog bumped it!', chickenHit: 'Chicken crossing!',
  ...
  zh: {
    ...
    level2Title: '侧风街区', level2Mission: '送达 4 件 · 强风 · 猫巡逻',
    level3Title: '狭窄落点', level3Mission: '送达 5 件 · 中心 1 次 · 狗巡逻',
    level4Title: '移动地址', level4Mission: '送达 4 件 · 得分 300',
    level5Title: '易碎快件', level5Mission: '送达 6 件 · 中心 2 次 · 鸡巡逻',
    level6Title: '天际终局', level6Mission: '送达 7 件 · 中心 2 次 · 500 分 · 猫狗',
    animalInterference: '动物干扰', catHit: '猫把箱子拍歪了！', dogHit: '狗撞到了箱子！', chickenHit: '小心，鸡横穿！',
